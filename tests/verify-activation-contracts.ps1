...
Assert-True ($routePolicy -match 'cost-incurring generation request' -and $routePolicy -match 'existing Cost Gate' -and $routePolicy -match 'do not create a Video Adapter intake') 'Route Policy must collect missing execution facts at the Cost Gate without adding a planning intake.'
...
Assert-True ($controllerSkill -match 'Do not create or require a Video Adapter intake before creative planning' -and $controllerSkill -match 'Immediately before a cost-incurring generation request' -and $controllerSkill -match 'estimated cost' -and $controllerSkill -match 'quantity') 'Controller must preserve creative entry and verify material execution facts at the existing Cost Gate.'
